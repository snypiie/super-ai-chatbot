...
export async function POST(
  ...
  try {
    ...
    if (records.length === 0) {
      // if no records then we vo to seed the chat history with the ex comversation
    ...
    const model = new Replicate({
      model:
        "a16z-infra/llama-2-13b-chat:a894e5a902ac35ebabdfab777bc36520e00e31616cf1caf1d043b13226db19ef",
      input: {
        max_length: 2048,
      },
